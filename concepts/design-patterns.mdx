---
title: "Design Patterns in Kimera Core: Singleton, Strategy, More"
sidebarTitle: "Design Patterns"
description: "Singleton, Strategy, Template Method, and Decorator patterns in Kimera Core — four Python Singleton implementations and real cache engine code examples."
---
...
In Kimera Core, `BaseCacheEngine` is the strategy interface. `InMemoryCacheEngine` and `ThreadCacheEngine` are concrete strategies. Swapping the engine requires changing only one constructor call — no other code changes.
